            ...
            <nav className="bg-white border-gray-200 border-b px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-lg">
                    ...
                    <div className="flex items-center lg:order-2">
                        <Link href="#" onClick={onClick} className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log out</Link>
                        <Link href="https://github.com/megmogmog1965/vulnerable-web-site" className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-4xl px-4 lg:px-5 py-0 lg:py-0 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"><FontAwesomeIcon icon={faGithubSquare} /></Link>
